...
const goToActivity = (id) => {
  if (id) router.push(`/teacher/activity/${id}`)
}
...
.section-title { font-size: 18px; font-weight: 600; color: var(--td-text-color-primary); display: flex; align-items: center; gap: 8px; margin: 0; }
.dot { width: 8px; height: 8px; border-radius: 50%; display: inline-block; }
.dot.online { background: var(--td-brand-color); }
.dot.offline { background: var(--td-warning-color); }
.section-count { font-size: 13px; color: var(--td-text-color-placeholder); }
.card-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px; }
.activity-card { cursor: pointer; transition: transform 0.2s, box-shadow 0.2s; border-radius: 10px; overflow: hidden; }
.activity-card:hover { transform: translateY(-2px); }
.card-cover { height: 160px; background-size: cover; background-position: center; background-color: #f0f2f5; position: relative; display: flex; align-items: center; justify-content: center; }
.cover-placeholder { display: flex; align-items: center; justify-content: center; }
.placeholder-icon { font-size: 40px; color: #d0d5dd; }
.status-tag { position: absolute; top: 12px; right: 12px; }
.card-title { font-size: 15px; font-weight: 600; color: var(--td-text-color-primary); line-height: 1.5; }
.card-meta { padding: 0 0 8px; }
.meta-item { display: flex; align-items: center; gap: 6px; font-size: 13px; color: var(--td-text-color-secondary); margin-bottom: 4px; }
.meta-icon { font-size: 14px; color: var(--td-text-color-placeholder); flex-shrink: 0; }
.card-footer-row { display: flex; align-items: center; justify-content: space-between; }
.pagination-wrap { display: flex; justify-content: center; margin-top: 32px; padding-bottom: 16px; }
