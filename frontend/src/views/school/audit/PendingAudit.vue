    ...
    >
      <div v-if="currentRecord" class="detail-content">
        <t-descriptions :column="2" bordered>
          ...
          <t-descriptions-item label="学院" :span="2">
            {{ currentRecord.collegeName || '-' }}
          </t-descriptions-item>
...
const columns = [
  ...
  { colKey: 'collegeName', title: '学院', width: 120, ellipsis: true },
  { colKey: 'activityTitle', title: '活动', minWidth: 160, ellipsis: true },
  { colKey: 'targetSchool', title: '目标学校', width: 150, ellipsis: true },
